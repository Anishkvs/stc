...
public class AutomationReports extends BaseTest implements ITestListener {
	...
	public void onStart(ITestContext context) {
		...
		try {
			...
			spark.config().setDocumentTitle("Automation Reports - STC");
			spark.config().setReportName("STC B2C Mobile Automation Results");
			...
			extent.setSystemInfo("Build No", "v5.4.3");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
